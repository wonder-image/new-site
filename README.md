# Wonder Image — Nuovo progetto

[Documentazione del framework](https://github.com/wonder-image/app/blob/main/docs/app/README.md) · [Avvio rapido](https://github.com/wonder-image/app/blob/main/docs/app/introduzione/avvio-rapido.md)
...
Se ti trovi già nella cartella generata da Composer, inizia da `composer update`, poi configura Git e `origin` come sopra ed esegui `php forge provision` e i passi successivi: non ripetere `create-project`.
